...
public class EightBitProvider {
	...
	EightBitProvider(int theNumberOfBand, int theNumberOfRows, int theNumberOfColumns)
	{
	...
	public boolean read(String theInputFile)
	{
		...
		{
			cvData = null;
			System.err.println("[read:IO ERROR] An exception was thrown while trying to write to "+ theInputFile);
			return false;
		}
